...
/* Edmunds-hosted reference photos. Replace with local files
   before launch. Both URLs have onerror fallbacks in main.js. */
const IMG_HERO   = 'https://www.edmunds.com/assets/m/cs/blt3a040f039760af86/672d46c51d8babc78be842bd/2026_cadillac_vistiq_exterior_front_3_4_2_1600.jpg';
const IMG_DETAIL = 'https://www.edmunds.com/assets/m/cs/cms/657e2149-5aa2-4332-b514-f4c3a7fc7a2a/2026+Cadillac+Vistiq+4_1600.jpg';
...
const CONFIG = {
  ...
  services: [
    ...
    },
    {
      num:  '04',
      name: 'Manhattan Runs',
      desc: 'Long Island to Manhattan and back — tailored timing, zero guesswork, all hours.',
    },
    {
      num:  '05',
  ...
  ---------------------------------------------------------- */
  coverage: {
    intro: 'We serve every door, every gate, every terminal — across the tri-state. Daily routes, advance reservations, and last-minute pickups all welcome.',
    groups: [
      {
        title: 'Long Island',
      ...
      {
        title: 'Tri-State',
        items: ['Westchester', 'New Jersey', 'Connecticut', 'Lower Hudson'],
      },
      {
        title: 'Airports',
