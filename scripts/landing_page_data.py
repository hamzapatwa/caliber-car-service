...
ALL_PAGES["corporate"] = base(
    ...
    airportStrategy=airport_strategy(
        ...
        [
            ...
            strategy_card("JFK", "JFK", "International hub", "Six terminals, global carriers, and meet-and-greet on request — the default for international and many premium domestic routes.", "jfk/", True),
...
ALL_PAGES["hourly"] = base(
    ...
    airportStrategy=airport_strategy(
        ...
        [
            strategy_card("JFK", "JFK", "Multi-terminal", "Best when your day includes international arrivals or departures — 60-minute complimentary wait on arrivals.", "jfk/"),
...
ALL_PAGES["manhattan"] = borough_page(
    ...
    airport_strategy(
        ...
        [
            ...
            strategy_card("JFK", "JFK", "International", "Six terminals, global carriers — meet-and-greet available.", "jfk/"),
...
ALL_PAGES["brooklyn"] = borough_page(
    ...
    airport_strategy(
        ...
        [
            strategy_card("JFK", "JFK", "Closest major hub", "Best for most international and many domestic flights — short hop from much of Brooklyn.", "jfk/", True),
    ...
    [{"label": "New York City", "href": "nyc/"}, {"label": "JFK", "href": "jfk/"}, {"label": "Cruise Terminals", "href": "cruise/"}, {"label": "Queens", "href": "queens/"}],
)
...
ALL_PAGES["queens"] = borough_page(
    ...
    airport_strategy(
        ...
        [
            ...
            strategy_card("JFK", "JFK", "International", "Default for global travel — all six terminals, 60-minute wait on arrivals.", "jfk/"),
            strategy_card("EWR", "Newark", "Alternate", "When fare or carrier fits — toll-inclusive from Queens.", "ewr/"),
        ],
    ),
    [{"label": "New York City", "href": "nyc/"}, {"label": "JFK", "href": "jfk/"}, {"label": "LaGuardia", "href": "lga/"}, {"label": "Great Neck", "href": "great-neck/"}],
)
...
ALL_PAGES["bronx"] = borough_page(
    ...
    airport_strategy(
        ...
        [
            ...
            strategy_card("JFK", "JFK", "International", "Required for most overseas itineraries — full terminal coverage.", "jfk/"),
...
ALL_PAGES["staten-island"] = borough_page(
    ...
    airport_strategy(
        ...
        [
            ...
            strategy_card("JFK", "JFK", "International", "When EWR does not have your route — cross-bridge timing built in.", "jfk/"),
...
ALL_PAGES["events"] = base(
    ...
    airportStrategy=airport_strategy(
        ...
        [
            strategy_card("JFK", "JFK", "Out-of-town guests", "Most international and many domestic guests land here — meet-and-greet keeps arrivals calm before the venue.", "jfk/", True),
...
ALL_PAGES["hamptons"] = base(
    ...
    airportStrategy=airport_strategy(
        ...
        [
            strategy_card("JFK", "JFK", "International & major domestic", "Still the primary hub for most Hamptons international travel — plan 90–120+ minutes ground time in peak season.", "jfk/", True),
...
ALL_PAGES["north-shore"] = base(
    ...
    airportStrategy=airport_strategy(
        ...
        [
            ...
            strategy_card("JFK", "JFK", "International", "Six terminals, global carriers — meet-and-greet and 60-minute wait on arrivals.", "jfk/"),
...
ALL_PAGES["westchester-ct"] = base(
    ...
    airportStrategy=airport_strategy(
        ...
        [
            ...
            strategy_card("JFK", "JFK", "International", "When HPN does not have your route or you need global connections — full meet-and-greet service.", "jfk/"),
...
ALL_PAGES["garden-city"] = town_page(
    ...
    airport_strategy(
        ...
        [
            ...
            strategy_card("JFK", "JFK", "International", "Default for overseas travel and many premium domestic carriers — 60-minute wait on arrivals.", "jfk/"),
    ...
    [{"label": "North Shore", "href": "north-shore/"}, {"label": "JFK", "href": "jfk/"}, {"label": "LaGuardia", "href": "lga/"}],
)
...
ALL_PAGES["great-neck"] = town_page(
    ...
    airport_strategy(
        ...
        [
            ...
            strategy_card("JFK", "JFK", "International", "Full terminal knowledge for global carriers — meet-and-greet in arrivals on request.", "jfk/"),
...
ALL_PAGES["manhasset"] = town_page(
    ...
    airport_strategy(
        ...
        [
            ...
            strategy_card("JFK", "JFK", "International", "When your schedule requires JFK — we build Van Wyck and LIE buffer into pickup time.", "jfk/"),
        ],
    ),
    [
...
ALL_PAGES["huntington"] = town_page(
    ...
    airport_strategy(
        ...
        [
            strategy_card("JFK", "JFK", "International", "Primary hub for most overseas and major domestic routes — plan 50–75+ minutes ground time.", "jfk/", True),
    ...
    [{"label": "Hamptons", "href": "hamptons/"}, {"label": "JFK", "href": "jfk/"}, {"label": "Manhattan", "href": "manhattan/"}],
)
...
ALL_PAGES["syosset"] = town_page(
    ...
    airport_strategy(
        ...
        [
            ...
            strategy_card("JFK", "JFK", "International", "International executives and roadshow guests — meet-and-greet available.", "jfk/"),
...
ALL_PAGES["rockville-centre"] = town_page(
    ...
    airport_strategy(
        ...
        [
            ...
            strategy_card("JFK", "JFK", "International", "Default for overseas travel — meet-and-greet and 60-minute wait on arrivals.", "jfk/"),
...
ALL_PAGES["melville"] = town_page(
    ...
    airport_strategy(
        ...
        [
            ...
            strategy_card("JFK", "JFK", "International", "Executive international travel — priority dispatch for accounts.", "jfk/"),
